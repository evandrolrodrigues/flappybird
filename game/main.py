...
IMAGEM_CANO = pygame.transform.scale2x(pygame.image.load(os.path.join('assets', 'img', 'pipe.png')))
IMAGEM_CHAO = pygame.transform.scale2x(pygame.image.load(os.path.join('assets', 'img', 'base.png')))
IMAGEM_BACKGROUND = pygame.transform.scale2x(pygame.image.load(os.path.join('assets', 'img', 'bg.png')))
IMAGENS_PASSARO = [
